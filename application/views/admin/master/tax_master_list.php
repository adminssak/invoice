<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">List of Tax</h3>
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_item" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> Add Tax</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		$('#create_item').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Add Tax ","<?php echo base_url('admin/master/manage');?>","mid-large")
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Update Tax","<?php echo base_url('admin/master/manage');?>/"+$(this).attr('data-id'),"mid-large")
		})
	...
	function delete_product($id){
		start_loader();
		$.ajax({
			url:"<?php echo base_url('admin/master/delete_data');?>",
			method:"POST",
			data:{id: $id},
			dataType:"json",
			error:err=>{
