<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_item" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> Add Company</a>
		</div>
	</div>
	<div class="card-body">
		<div class="container-fluid">
			<table class="table table-bordered table-stripped table responsive" style="width: 100%;">
				<thead>
					<tr style="width: 100%;">
						<th>#</th>
						<th>Company Name</th>
...
<script>
	$(document).ready(function(){
		$('#create_item').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Add Company ","<?php echo base_url('admin/company/manage');?>","mid-large")
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Update Company","<?php echo base_url('admin/company/manage');?>/"+$(this).attr('data-id'),"mid-large")
		})
	...
	function delete_product($id){
		start_loader();
		$.ajax({
			url:"<?php echo base_url('admin/company/delete_data');?>",
			method:"POST",
			data:{id: $id},
			dataType:"json",
			error:err=>{
